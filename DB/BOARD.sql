...
insert into board_inquiry(p_writer, p_title, p_text) values ('user1', '테스트1입니다.', '테스트1이에요');
insert into board_inquiry(p_writer, p_title, p_text) values ('user1', '테스트2입니다.', '테스트2이에요');
